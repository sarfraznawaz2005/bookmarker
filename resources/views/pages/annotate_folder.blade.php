...
<div id="annotator__header_elements_container">
    <div class="header">
        ...
        <div class="left">
            <form action="{{ url('/').'/delete_bookmark_annotate_folder/'.$bookmark->folder->id.'/'.$bookmark->id }}"
                  method="POST">
                {{ csrf_field() }}
                {{ method_field('DELETE') }}
        ...
        @if($nextBookmark)
            <div class="right">
                <a class="link" title="{{$nextBookmark->title}}" href="{{url('/')}}/annotate_folder/{{$id}}/{{$nextBookmark->id}}">
        ...
        @if($prevBookmark)
            <div class="right">
                <a class="link" title="{{$prevBookmark->title}}" href="{{url('/')}}/annotate_folder/{{$id}}/{{$prevBookmark->id}}">
